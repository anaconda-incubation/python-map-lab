...
export default function TopNav() {
  ...
  return <header className="atlas-nav">
    ...
    <a className="pf-anaconda" href="https://www.anaconda.com/" target="_blank" rel="noopener noreferrer" aria-label="By Anaconda (opens in a new tab)"><span className="pf-anaconda-by">BY</span><img src="/anaconda-logo.png" width="510" height="88" alt="Anaconda" /></a>

...
export default function TopNav() {
  ...
  return (
    <header className="atlas-nav">
      <a href="/" className="atlas-wordmark">
        <span className="hidden sm:inline">
          Every flat map of our 3D world involves tradeoffs
        </span>
        <span className="sm:hidden">A world of maps</span>
      </a>
      <a
      ...
      >
        <span className="pf-anaconda-by">BY</span>
      ...
      <nav aria-label="Site" className="atlas-nav-links">
        ...
        <button
          ...
          aria-label={
            reducedMotion
              ? 'Reduced motion on; enable full motion'
              : 'Reduce motion'
          }
          onClick={toggle}
        >
